      ...
      <div className="flex-1 w-full relative flex justify-center">
        ...
        <div className="relative bg-card/30 border border-white/10 shadow-2xl p-3 rounded-[3rem] flex justify-center items-center h-[500px] w-[250px] backdrop-blur-xl">
           ...
           <div className="w-full h-full bg-black rounded-[2.2rem] border-[4px] border-zinc-900 overflow-hidden flex items-center justify-center relative shadow-inner">
             ...
             {/* TikTok Logo SVG */}
             <svg width="70" height="70" viewBox="0 0 24 24" fill="white" xmlns="http://www.w3.org/2000/svg" className="drop-shadow-lg z-0">
               <path d="M19.589 6.686a4.793 4.793 0 01-3.97-1.561 4.795 4.795 0 01-1.236-3.184h-3.98v13.303a3.981 3.981 0 01-3.98 3.98 3.981 3.981 0 01-3.98-3.98 3.981 3.981 0 013.98-3.98c.176 0 .347.016.516.042V7.185a7.973 7.973 0 00-4.496 7.11 7.981 7.981 0 007.98 7.98 7.981 7.981 0 007.98-7.98V8.903a8.815 8.815 0 005.185 1.686v-3.98a4.811 4.811 0 01-3.979-.809z"/>
             </svg>
           </div>
        </div>
      </div>
