  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      {analysesWithUrls.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-20 px-4 border border-dashed border-border rounded-3xl bg-transparent">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          {analysesWithUrls.map((analysis) => (
            <Link 
              ...
              key={analysis.id}
              className="group block relative overflow-hidden rounded-3xl border border-border bg-card hover:bg-zinc-800/50 transition-all hover:border-border hover:shadow-2xl hover:shadow-purple-500/10"
            >
